...
const Footer = () => {
  return (
    <footer className="text-white border-t border-fourthcolor flex flex-col justify-center gap-4 p-6">
      <div className="w-full flex justify-between items-center mb-5">
        ...
        />
        <span className="flex justify-center items-center gap-4 text-text font-medium">
